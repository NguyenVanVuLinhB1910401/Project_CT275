...
<div class="content">
    <table class="table ">
        ...
        <tr>
            ...
            <td class="text-center py-5">
                <div><?php echo number_format($food[4], 0,'','.');?></div>
            </td>
            <td class="text-center py-5">
                <a href="/cart/delete/<?php echo $key;?>" class="btn-danger border rounded p-2"
                    style="width: 150px;text-decoration: none;">Xóa</a>
            </td>
        </tr>
        <?php 
        ...
        <tr>
            ...
            <td class="text-center">
                <h5 class="pt-1"><?=number_format($tongtien, 0,'','.')?> VNĐ</h5>
            </td>
        </tr>
    ...
    <div>
        <a href="/user/checkout" class="btn-success border rounded py-2 px-4"
            style="width: 150px;text-decoration: none;">Đặt hàng</a>
        <a href="/cart/delete_all" class="btn-danger border rounded p-2" style="width: 150px;text-decoration: none;">Xóa
            giỏ hàng</a>
        <a href="/food" class="btn-primary border rounded p-2" style="width: 150px;text-decoration: none;">Tiếp tục đặt
            hàng</a>
    </div>
</div>
