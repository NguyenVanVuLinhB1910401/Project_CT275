    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="col-sm-9 pt-3" style="background-color: hsla(89, 43%, 51%, 0.3);">
                ...
                <hr>
                <div class="my-4">
                    <a href="/admin_category/add"><button class="btn-primary border p-2" style="width: 100px;">Thêm
                            loại</button></a>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {
                                ?>
                                <img src="images/category/<?php echo $category->image_name; ?>" width="150px"
                                    height="75">
                                <?php
                                }
                            ...
                            <td>
                                <a href="/admin_category/edit/<?= $category->id?>"><button
                                        class="btn-secondary border p-2">Cập nhật</button></a>
                                <a id="<?= $category->id?>"><button
                                        class="btn-danger border p-2 delete">Xóa</button></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
