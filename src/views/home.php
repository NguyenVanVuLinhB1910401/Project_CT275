        ...
        <div class="col-sm-3 padding-1 mb-2">
            <div class="rounded" style=" background-image: linear-gradient(#2feb60, #1edce6);">
                <a href="/category/food/<?=$category->id?>">
                    <img style="width: 100%;height:350px;" src="images/category/<?php echo $category->image_name; ?>"
        ...
        <div class="col-sm-3 padding-1 mb-2">
            <div class="rounded" style=" background-image: linear-gradient(#2feb60, #1edce6);">
                <a href="/detail_food/<?=$food->id?>">
                    <img style="width: 100%;height:250px;" src="/images/food/<?php echo $food->image_name; ?>" alt=""
                ...
                <form action="<?= $router->generate('addcart') ?>" method="POST">
                    ...
                    <div class="p-2">
                        <input class=" btn-success border form-control" type="submit" name="addcart" value="Add Cart">
                    </div>
