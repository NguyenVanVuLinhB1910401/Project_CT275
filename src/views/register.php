                    ...
                    <div class="mx-auto col-md-6 col-12 px-2 py-1 rounded-2">
                        <div class="mx-3 pb-2 pt-4">
                            ...
                            <form class="my-2 mx-3" action="<?= $router->generate('user.create') ?>" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <input type="text" name="username" placeholder="Tên đăng nhập"
                                                style="height: 45px;" class="form-control rounded-2 mb-xl-4 text-dark"
                                                id="username" aria-describedby="emailHelp" required>
                                        </div>
                                        <div class="mb-4">
                                            <input type="password" name="password" placeholder="Mật khẩu"
                                                style="height: 45px;" class="form-control rounded-2 text-dark" id="psw"
                                                required>
                                        </div>
                                        <div class="mb-4">
                                ...
                                <button type="submit" name="dangky" style="height: 55px;"
                                    class="btn btn-success fw-bold text-dark  col-12 rounded-2 mt-lg-2">ĐĂNG KÝ</button>

                                <div class="row mx-auto mt-2">
                                    <div class="col-12 text-center" style="font-size: 20px;">
                                        Đã có tài khoản?<a href="/user/login" class="link-success"
