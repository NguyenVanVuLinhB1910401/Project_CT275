        ...
        <div class="col-md-9 pt-2">
            ...
            <table class="table ">
                ...
                <tr>
                    ...
                    <td class="text-center"><img src="/images/food/<?=$food->hinhsp?>" width="150px" height="100px">
                    </td>
                    <td class="text-center py-5"><?php echo number_format($food->dongia, 0,'','.');?></td>
                    <td class="text-center py-5"><?=$food->soluong?></td>
                    <td class="text-center py-5">
                        <div><?php echo number_format($food->thanhtien, 0,'','.');?></div>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <h5 class="pt-1"><?=number_format($bill->total, 0,'','.')?> VNĐ</h5>
                    </td>
                </tr>
            </table>
        </div>
        <div class="col-md-3 pt-2">
            ...
            <form action="<?= $router->generate('user.huybill') ?>" method="POST">
                <div>
                    ...
                    <input class="form-control btn-danger border rounded" name="submit" type="submit"
                        value="Hủy đơn hàng">
                </div>
            </form>
            <?php
